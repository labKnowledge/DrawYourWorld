...
export function useYjsStore({
	...
	useEffect(() => {
		...
		function handleSync() {
			...
			room.awareness.setLocalStateField('presence', presenceDerivation.__unsafe__getWithoutCapture())

			// When the derivation change, sync presence to to yjs awareness
			unsubs.push(
				react('when presence changes', () => {
					const presence = presenceDerivation.__unsafe__getWithoutCapture()
